package dev.alnat.ustorage.core.system.scp;
 ...
 */
public class SCPStorageSystem extends AbstractStorageSystem {

    public SCPStorageSystem(SystemConfiguration systemConfiguration) {
