package dev.alnat.ustorage.core.system.ftp;
 ...
 */
public class SFTPStorageSystem extends AbstractStorageSystem {

    public SFTPStorageSystem(SystemConfiguration systemConfiguration) {
