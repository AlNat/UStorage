package dev.alnat.ustorage.core.system.database.redis;
 ...
 */
public class RedisStorageSystem extends AbstractStorageSystem {

    public RedisStorageSystem(SystemConfiguration systemConfiguration) {
