package dev.alnat.ustorage.core.system.s3.ceph;
 ...
 */
public class CephStorageSystem extends S3CompatibleStorageSystem {

    public CephStorageSystem(SystemConfiguration systemConfiguration) {
